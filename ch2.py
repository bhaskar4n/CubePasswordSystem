...
def displayClick(n_clicks):
    ...
    return {'data':[
                ...
                go.Scatter(x=[ch2x[int(burn6)]],y=[ch2y[int(burn6)]],mode='markers',text = 'burn6 - 14.08.2019 (Trans lunar insertion): 278.4 x 412505 km)',name='Trans lunar insertion',marker=dict(size=5,color='red'),hoverinfo='text')
				],'layout': go.Layout(
                xaxis={'showgrid':False,'zeroline': False,'showticklabels':False},
                yaxis={'showgrid':False,'zeroline': False,'showticklabels':False},
