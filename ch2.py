...
dcc.Markdown(d("""
            ...
            Last updated on 18.08.2018 | data collected from jpl horizons system| For Geocentric view, data available from 23.07.2019 to 20.08.2019 | For moon(body-center)view, data available from 13.08.2019 to 20.08.2019 | To view the information, keep the mouse pointer on the satellite.
