...
app.layout = html.Div([
    dcc.Graph(id='graph',style={'height':'100vh','color':'black'},figure={
            'data': [
                go.Scatter3d(
                )],'layout': go.Layout(
	...
	),html.Button('current_position', id='btn-1', n_clicks=0),	
...
def displayClick(n_clicks):
    ...
    return {'data':[
                go.Scatter3d(
                    ...
                    text=str(central)+' IST<br>'+'Chandrayaan2<br>'+'Distance btw earth & ch2: '+str(cr)[:-7]+' km<br>'+ 'Distance btw moon & ch2: '+str(mr)[:-7]+' km<br>'+'velocity wrt Earth:'+str(vl)[:-12]+' km/s<br>velocity wrt to moon:' +str(mvl)[:-12]+' km/s<br>',
                    name = 'Chandrayaan2',
                    hoverinfo='text'),
                    ...
                    xaxis = dict(
                         #backgroundcolor="rgba(244,22,100,0.6)",
                         #gridcolor="black",
                    ...
                    zaxis = dict(
                        ...
                        #gridcolor="black",
                        showbackground=True,showticklabels=False,
                        zerolinecolor="black",),),scene_aspectmode='manual',
                  scene_aspectratio=dict(x=1.5, y=1.5, z=1.5),margin=dict(r=0, l=100, b=150, t=11))
