...
def displayClick(value):
    ...
    return {'data':[
                ...
                go.Scatter(x=[ch2x[int(burn1)]],y=[ch2y[int(burn1)]],mode='markers',text = 'burn1',name='burn1',marker=dict(size=5,color='red'),hoverinfo='text'),
                go.Scatter(x=[ch2x[int(burn2)]],y=[ch2y[int(burn2)]],mode='markers',text = 'burn2',name='burn2',marker=dict(size=5,color='red'),hoverinfo='text'),
                go.Scatter(x=[ch2x[int(burn3)]],y=[ch2y[int(burn3)]],mode='markers',text = 'burn3',name='burn3',marker=dict(size=5,color='red'),hoverinfo='text'),
                go.Scatter(x=[ch2x[int(burn4)]],y=[ch2y[int(burn4)]],mode='markers',text = 'burn4',name='burn4',marker=dict(size=5,color='red'),hoverinfo='text'),
                go.Scatter(x=[ch2x[int(burn5)]],y=[ch2y[int(burn5)]],mode='markers',text = 'burn5',name='burn5',marker=dict(size=5,color='red'),hoverinfo='text') 
				],'layout': go.Layout(
                xaxis={'showgrid':False,'zeroline': False,'showticklabels':False},
                yaxis={'showgrid':False,'zeroline': False,'showticklabels':False},
